...
abstract class ChatCompletionMessageToolCall
  ...
  factory ChatCompletionMessageToolCall(
          [void updates(ChatCompletionMessageToolCallBuilder b)]) =
  ...
  static Serializer<ChatCompletionMessageToolCall> get serializer =>
      _$ChatCompletionMessageToolCallSerializer();
}

class _$ChatCompletionMessageToolCallSerializer
    implements PrimitiveSerializer<ChatCompletionMessageToolCall> {
  @override
      ...
      switch (key) {
        ...
        case r'type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(ChatCompletionMessageToolCallTypeEnum),
        ...
        case r'function':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(ChatCompletionMessageToolCallFunction),
...
class ChatCompletionMessageToolCallTypeEnum extends EnumClass {
  /// The type of the tool. Currently, only 'function' is supported.
  @BuiltValueEnumConst(wireName: r'function', fallback: true)
  static const ChatCompletionMessageToolCallTypeEnum function_ =
      _$chatCompletionMessageToolCallTypeEnum_function_;

  static Serializer<ChatCompletionMessageToolCallTypeEnum> get serializer =>
      _$chatCompletionMessageToolCallTypeEnumSerializer;

  const ChatCompletionMessageToolCallTypeEnum._(String name) : super(name);

  static BuiltSet<ChatCompletionMessageToolCallTypeEnum> get values =>
      _$chatCompletionMessageToolCallTypeEnumValues;
  static ChatCompletionMessageToolCallTypeEnum valueOf(String name) =>
      _$chatCompletionMessageToolCallTypeEnumValueOf(name);
}
