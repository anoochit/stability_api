...
/// * [function_]
@BuiltValue()
abstract class ChatCompletionTool
    implements Built<ChatCompletionTool, ChatCompletionToolBuilder> {
  ...
  factory ChatCompletionTool([void updates(ChatCompletionToolBuilder b)]) =
  ...
  static Serializer<ChatCompletionTool> get serializer =>
      _$ChatCompletionToolSerializer();
}

class _$ChatCompletionToolSerializer
    implements PrimitiveSerializer<ChatCompletionTool> {
  @override
...
class ChatCompletionToolTypeEnum extends EnumClass {
  ...
  static const ChatCompletionToolTypeEnum function_ =
      _$chatCompletionToolTypeEnum_function_;

  static Serializer<ChatCompletionToolTypeEnum> get serializer =>
      _$chatCompletionToolTypeEnumSerializer;

  const ChatCompletionToolTypeEnum._(String name) : super(name);

  static BuiltSet<ChatCompletionToolTypeEnum> get values =>
      _$chatCompletionToolTypeEnumValues;
  static ChatCompletionToolTypeEnum valueOf(String name) =>
      _$chatCompletionToolTypeEnumValueOf(name);
}
