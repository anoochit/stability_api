...
part 'masking_using_init_image_alpha_request_body.g.dart';
...
@BuiltValue()
abstract class MaskingUsingInitImageAlphaRequestBody
    implements
        GenerationRequestOptionalParams,
        Built<MaskingUsingInitImageAlphaRequestBody,
  ...
  MaskingUsingInitImageAlphaRequestBody._();

  factory MaskingUsingInitImageAlphaRequestBody(
          [void updates(MaskingUsingInitImageAlphaRequestBodyBuilder b)]) =
      _$MaskingUsingInitImageAlphaRequestBody;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MaskingUsingInitImageAlphaRequestBodyBuilder b) => b
    ..seed = 0
    ..cfgScale = 7
    ..steps = 30
    ..samples = 1;
  ...
  static Serializer<MaskingUsingInitImageAlphaRequestBody> get serializer =>
      _$MaskingUsingInitImageAlphaRequestBodySerializer();
}

class _$MaskingUsingInitImageAlphaRequestBodySerializer
    implements PrimitiveSerializer<MaskingUsingInitImageAlphaRequestBody> {
  @override
  ...
  @override
  final String wireName = r'MaskingUsingInitImageAlphaRequestBody';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MaskingUsingInitImageAlphaRequestBody object, {
  ...
  void _deserializeProperties(
    ...
    required MaskingUsingInitImageAlphaRequestBodyBuilder result,
  ...
  @override
  MaskingUsingInitImageAlphaRequestBody deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MaskingUsingInitImageAlphaRequestBodyBuilder();
